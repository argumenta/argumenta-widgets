...
function( $, Base, Template ) {
    ...
    var Sidebar = Base.module( {
        ...
        init: function( options, originalElem ) {
            ...
            // Save the original element and refresh
        ...
        prototype: {
            ...
            _bindUI: function() {
                ...
                if ( self.originalElement ) {
                    self.element.find('.sidebar-contents')
                                .empty()
                ...
                $( window ).resize( function() {
                    // Resize & clear assumption about our relative position
            ...
            update: function() {
                ...
                // Floating sidebar
                // Follows the window view, within the bounds of its parent.
                // Anchors to the parent boundaries at the top & bottom.
                // Uses "position: fixed" for smooth scrolling in the middle case.
